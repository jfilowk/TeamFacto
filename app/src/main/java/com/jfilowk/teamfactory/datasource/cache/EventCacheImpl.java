...
public class EventCacheImpl implements EventCache {
  ...
  @Override public void getEvents(EventCacheCallback callback) {
  ...
  @Override public void getEvent(Event eventSend, AnEventCacheCallback callback) {
    ...
    for (idTeams.moveToFirst(); !idTeams.isAfterLast();
        idTeams.moveToNext()) { // iterate to the users id cursor
      ...
      for (cursorUsersTeam.moveToFirst(); !cursorUsersTeam.isAfterLast();
          cursorUsersTeam.moveToNext()) {
