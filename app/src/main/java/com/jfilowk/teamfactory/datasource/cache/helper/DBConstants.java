...
public class DBConstants {
    ...
    public static final String CREATE_TABLE_RANDOM = "CREATE TABLE " + TABLE_USER + "(id INTEGER PRIMARY KEY AUTOINCREMENT, first_name TEXT, last_name TEXT, picture TEXT, gender TEXT, seed TEXT, " + KEY_CREATED_AT + " DATETIME)";
    ...
    public static final String CREATE_TABLE_RANDOM_EVENT = "CREATE TABLE " + TABLE_RANDOM_EVENT + "(id INTEGER PRIMARY KEY AUTOINCREMENT, id_user INTEGER, id_event TEXT, " + KEY_CREATED_AT + " DATETIME)";
}
