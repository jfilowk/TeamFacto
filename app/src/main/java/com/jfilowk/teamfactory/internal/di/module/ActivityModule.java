...
public class ActivityModule {
  ...
  @Provides @PerActivity FragmentGenerateTeamPresenter provideFragmentGenerateTeamPresenter(FragmentGenerateTeamPresenterImpl fragmentGenerateTeamPresenter) {
    return fragmentGenerateTeamPresenter;
  }


  @Provides @PerActivity GenerateTeamPresenter provideGenerateTeamPresenter(GenerateTeamPresenterImpl generateTeamPresenter) {
